    ...
    >
      ...
      {image && thumbnailUrl ? (
        ...
        <button
          type="button"
          onClick={triggerUpload}
          className="flex flex-col items-center justify-center cursor-pointer w-full py-3 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-primary)] rounded-md"
        >
